...
//      stack.push(LOWESTSING);
    ...
    public static boolean compareTo(String strParm){
        ...
        try {
        	...
        	if(-1 != str.indexOf(">=")){
        		...
        		if (isNumber(strTemps[0]) && isNumber(strTemps[1])) {
        		...
        		if (isNumber(strTemps[0]) && isNumber(strTemps[1])) {
        			...
        			if(judge(strTemps)){
        				...
        				if (strTemps[0].equals(strTemps[1])) {
        					reBoolean = true;
        				}else {
        					reBoolean = false;
        				}
    ...
    public static boolean judge(String[] strTemps) {
    	if(strTemps[0].indexOf("*") != -1 || strTemps[0].indexOf("/") != -1 || strTemps[0].indexOf("+") != -1 || strTemps[0].indexOf("-") != -1 || strTemps[1].indexOf("*") != -1 || strTemps[1].indexOf("/") != -1 || strTemps[1].indexOf("+") != -1 || strTemps[1].indexOf("-") != -1){
    		return true;
    	}else {
			return false;
		}
...
//      System.out.println(m.matches());
        ...
        MathExpress me1 = new MathExpress("a");
