...
<div class="error-page">
    <div class="error-page-info">
        <div style="width: 400px;height: 400px;position: absolute;top: 50%;left: 50%;transform: translate(-50%,-50%);">
            ...
            <h3 class="font-bold" style="position: absolute;top: 50%;left: 50%;transform: translate(-50%, -50%);margin-top: 50px;color: #666;font-size: 16px;font-weight: 400;">啊哦，错误的请求</h3>
        </div>
    </div>
</div>
</body>
