...
;layui.define("jquery", function(t) {
    ...
    var o = ".layui-nav"
      ...
      , f = {
        ...
        clickThis: function() {
            ...
            c[0] && (event.target.nodeName == 'A'|| t[0].nodeName == "A") && (s["none" === c.css("display") ? "addClass" : "removeClass"](r + "ed"),
            s[0].nodeName == "LI" && a("." +u+" ."+r+" > ."+d).css("height", "") && "block" === c.css("display") && i.attr("lay-expand") == "accordion" && c.height(h1 > 200 ? h1: 200),
            "all" === i.attr("lay-shrink") && s[0].nodeName != "DD" && s.siblings().removeClass(r + "ed"))),
            (!event || !event.target || event.target.nodeName != 'SPAN') && layui.event.call(this, e, "nav(" + n + ")", t)
        },
        collapse: function() {
            var t = a(this)
            ...
            nav: function() {
                var t = 200
                  ...
                  , b = function(l, o, r) {
                    ...
                    l.css({
                        left: c.position().left + o.scrollLeft() + parseFloat(c.css("marginLeft")),
    ...
    b.on("click.tabClick", v, f.tabClick),
