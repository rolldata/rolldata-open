...
layui.define(['jquery'], function (exports) {
    ...
    var dropdown = {
        ...
        on: function(events, callback) {
			return layui.onevent.call(this, 'dropdown', events, callback);
		},
        init: function () {
        ...
        showDropdown: function (target) {
            ...
            var filter = $dropdown.attr("lay-filter");
            if(filter){
                layui.event.call($trigger, "dropdown", 'showDropdownMenu(' + filter+ ')', {
                    node: $trigger
                });
            }
            $dropdown.css({
    ...
    layui.link(layui.cache.base + 'dropdown/dropdown1.css');

    dropdown.init();

    exports('dropdown1', dropdown);
});
