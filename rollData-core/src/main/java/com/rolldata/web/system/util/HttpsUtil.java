...
public class HttpsUtil {
    private static Logger log = LogManager.getLogger(HttpsUtil.class);
    ...
    public static byte[] sentGet(String uri) throws IOException {
        HttpURLConnection httpConn = getHttpURLConnection(uri, "GET");
        return getBytesFromStream(httpConn.getInputStream());
    }

    public static byte[] sendPost(String uri, String data) throws IOException {
