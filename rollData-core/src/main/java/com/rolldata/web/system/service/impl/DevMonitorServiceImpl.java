...
import com.rolldata.web.system.util.CommonNetWorkInfoUtil;
...
/**
 * @Title: DevMonitorServiceImpl
 * @Description: 监控Service接口实现类
 * @Company: www.wrenchdata.com
 * @author: zhaibx
 * @date: 2025-02-06
 * @version: V1.0
 */
@Service("devMonitorService")
@Transactional
public class DevMonitorServiceImpl implements DevMonitorService {
    @Override
    public DevMonitorServerResult queryServerInfo() {
        ...
        devMonitorCpuInfo.setCpuName(cpu.getProcessorIdentifier().getName().trim());
    ...
    @Override
    public DevMonitorServerResult queryNetworkInfo() {
        DevMonitorServerResult devMonitorServerResult = new DevMonitorServerResult();
        // 网络信息
