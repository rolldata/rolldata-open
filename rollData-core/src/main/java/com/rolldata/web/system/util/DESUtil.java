...
public static void main(String[] args) {
	...
	String data = userCode+","+nowDateTime;
	String password = "LjUaiKpbImsXA0FNB79Zrg";
	System.out.println("time:"+nowDateTime);
	System.out.println("data:"+data);
	System.out.println("加密后："+encrypt(password,data));
    userCode = "lisi";
    data = userCode+","+nowDateTime;
    System.out.println("data:"+data);
    System.out.println("加密后："+encrypt(password,data));
    ...
    System.out.println("data:"+data);
    System.out.println("加密后："+encrypt(password,data));
//	System.out.println(decrypt(password,"dMCGRJRmsXLqjzpOC9v0FQ=="));
	String decrypt = DESUtil.decrypt(password,"M9kEYy4fj/LYxb8MWgvz4Rq6+rqOysee");
